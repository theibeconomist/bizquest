...
const QUESTIONS_1_2 = [
  ...
  { id: "s18", section: "structured", label: "Structured", num: 16, prompt: "With reference to Jobs, Wozniak and Wayne's 1976 partnership, describe one advantage and one disadvantage of unlimited liability for a business owner.", marks: 4,
    rubric: `Mark as 2+2. For the advantage: award 1 mark for identifying it (e.g. no separate legal registration needed before trading; simpler business structure; owner keeps direct/full control) and 1 mark ONLY if the answer explicitly applies it to the case — Jobs, Wozniak and Wayne were able to start Apple as a partnership on April 1, 1976 and begin trading almost immediately, without first navigating a formal incorporation process. For the disadvantage: award 1 mark for identifying it (e.g. personal assets — house, car, savings — are at risk if the business cannot pay its debts) and 1 mark ONLY if the answer explicitly applies it to the case — this is exactly why Ronald Wayne sold his 10% stake for $800 and left the partnership within twelve days of its founding.` },
...
const SUBUNIT_OUTCOMES = {
  "1.1": [
    ...
    "describe the challenges and opportunities involved in starting a business",
  ],
  "1.2": [
    ...
    "evaluate the main features of for-profit social enterprises and cooperatives",
    "evaluate the main features of non-governmental organizations (NGOs)",
  ],
  "1.3": [
    "distinguish a vision statement from a mission statement",
    "describe common business objectives, including growth, profit, protecting shareholder value and ethical objectives",
    "evaluate strategic and tactical objectives, and how they should relate to each other",
    "evaluate a firm's approach to corporate social responsibility (CSR)",
  ],
  "1.4": [
    "describe a business's internal stakeholders",
    "describe a business's external stakeholders",
    "explain conflict between stakeholders",
  ],
  "1.5": [
    "describe internal economies and diseconomies of scale",
    "describe external economies and diseconomies of scale",
    "evaluate the difference between internal and external growth",
    "evaluate reasons for businesses to grow",
    "evaluate reasons for businesses to stay small",
    "evaluate external growth methods, including mergers and acquisitions, takeovers, joint ventures, strategic alliances and franchising",
  ],
  "1.6": [
    "evaluate the impact of multinational companies (MNCs) on host countries",
  ],
};
